## For: multiway/prcc sensitivity analyses using LHS parameter sampling
...
get_grid <- function(parmat, pars_min, pars_max) {
  
  parmat <- t( apply(parmat, 1, function(x) qunif(x, as.numeric(pars_min), as.numeric(pars_max)) ) ) %>% data.frame()
...
pars_min_low <- c(hd_frac = 0.6, hd_frac_miss = 0.0, hd_frac_gain = 0.0, ndelay = 0,  hdVE_mult = 1.075)
pars_max_low <- c(hd_frac = 0.8, hd_frac_miss = 0.2, hd_frac_gain = 0.2, ndelay = 42, hdVE_mult = 1.525)

pars_min_high <- c(hd_frac = 0.6, hd_frac_miss = 0.0, hd_frac_gain = 0.0, ndelay = 0,  hdVE_mult = 1.15)
pars_max_high <- c(hd_frac = 0.8, hd_frac_miss = 0.2, hd_frac_gain = 0.2, ndelay = 42, hdVE_mult = 2.05 )
...
parmat_low  <- get_grid(parmat, pars_min_low,  pars_max_low)
parmat_high <- get_grid(parmat, pars_min_high, pars_max_high)
...
save(all, file = paste0("results/LHS_prcc_array", array_id, "of", tot_array, "_", datestamp, ".RData"))
